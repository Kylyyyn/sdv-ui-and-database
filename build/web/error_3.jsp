...
<html>
    <head>
        ...
        <title>Error - No Email Provided</title>
    ...
    <body>
        ...
        <div id="background" style="pointer-events: none;">
            ...
            <div id="user-info">
                ...
                <p>You entered a password but left the email field blank.</p>
                <p>Please enter your email address and try again.</p>
            </div>
        </div>
